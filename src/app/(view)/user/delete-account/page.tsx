      ...
      {isFinal ? (
        ...
        <div className="mx-[8%] h-full w-full max-w-[560px]">
          ...
          <div className="flex justify-end">
            ...
            <p className="text-xs font-normal text-cool-grayscale-800">/100</p>
          </div>
          ...
          <div className="inline-flex w-full items-center justify-start gap-4 py-4">
            <div className="flex h-[37px] shrink grow items-center justify-center rounded bg-slate-100">
              <div className="text-center text-sm font-bold leading-[21px] text-slate-500">
                취소하기
              </div>
            </div>
            <div className="flex h-[37px] shrink grow items-center justify-center rounded bg-[#c4c4c4]">
