  ...
  return (
    <ul className="list-none space-y-3">
      {Array.from({ length: count }).map((_, index) => (
        <li
          key={index}
          className="flex cursor-pointer flex-row items-center justify-between rounded-lg border-b border-t border-b-cool-grayscale-50 border-t-cool-grayscale-50 py-2 shadow-md transition hover:bg-cool-grayscale-100"
        >
          <div className="mx-[4%] my-2 flex items-center">
            ...
            <div className="ml-2 flex flex-col">
              ...
              <div className="mt-1 h-3 w-24 animate-pulse rounded bg-cool-grayscale-200"></div>
            </div>
          </div>
