      ...
      <div className="inline-flex h-[443px] w-[361px] flex-col items-center justify-start gap-4 rounded-2xl bg-white p-6">
        <div className="flex h-[155px] flex-col items-start justify-start gap-2 self-stretch">
          ...
          <div className="inline-flex items-start justify-start gap-2 self-stretch">
            <div className="text-center font-['Pretendard'] text-base font-normal leading-normal text-slate-600">
              닉네임
            </div>
            <div className="shrink grow basis-0 text-right font-['Pretendard'] text-base font-normal leading-normal text-slate-600">
              {nickname}
            </div>
          </div>
          <div className="inline-flex items-start justify-start gap-2 self-stretch">
        ...
        <div className="flex h-[52px] flex-col items-start justify-start gap-1 self-stretch">
          <div className="self-stretch text-center font-['Pretendard'] text-base font-normal leading-normal text-slate-500">
            선호 전통주
          </div>
          <div className="self-stretch text-center font-['Pretendard'] text-base font-medium leading-normal text-orange-400">
            {preferredAlcoholType.join(", ")}
          </div>
        </div>
        <div className="inline-flex h-[0px] w-[313px] items-center justify-center"></div>
        <div className="self-stretch text-center font-['Pretendard'] text-base font-bold leading-normal text-slate-700">
          입력하신 정보가 맞나요?
        </div>
