    ...
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-black bg-opacity-60">
      <div className="flex w-[91%] max-w-[560px] flex-col items-center gap-6 rounded-2xl bg-white p-6">
        ...
        <div className="flex w-full flex-col gap-2">
          ...
          <div className="bg-slate-100/opacity-0 inline-flex w-full items-center justify-center gap-2.5 rounded px-3 py-2">
            <button
              onClick={handleCancel}
              className="w-full text-center text-sm font-bold leading-[21px] text-cool-grayscale-500"
            >
              {cancelText}
            </button>
          </div>
